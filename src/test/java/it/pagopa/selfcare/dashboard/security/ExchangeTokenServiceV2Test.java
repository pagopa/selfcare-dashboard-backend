...
package it.pagopa.selfcare.dashboard.app.security;
...
class ExchangeTokenServiceV2Test  {
    ...
    @ParameterizedTest
    @EnumSource(PrivateKey.class)
    void exchange_nullEnvProperty(PrivateKey privateKey) throws InvalidKeySpecException, NoSuchAlgorithmException, IOException {
        // given
        String realm = "identityTokenAudienceFromProduct";
        String jti = "id";
        String sub = "subject";
